...
export interface WebSocketMessage {
  type: 'qr' | 'connected' | 'disconnected' | 'logout' | 'chats_updated' | 'contacts_updated' | 'groups_updated' | 'new_message' | 'connection_status' | 'sessions_updated' | 'account_qr' | 'account_connected' | 'account_disconnected' | 'account_removed';
  data?: any;
}
